...
@section('base')
    <div class="nftmax-wc__form">
        <div class="nftmax-wc__form-inner">
            ...
            <!-- Sign in Form -->
            <form class="nftmax-wc__form-main" action="{{ route('auth-backbone.submitLogin') }}" method="POST">
                @csrf
                <div class="form-group">
                    <label class="nftmax-wc__form-label">Select a Domain</label>
                    <div class="form-group__input">
                        @php
                            $webTypes = ['law' => 'kamuhukumjournal.com', 'economic' => 'oeajournal.com'];
                        @endphp
                        <select name="web_type" id="web_type">
                            @foreach ($webTypes as $key => $value)
                                <option value="{{ $key }}" @if (old('web_type') == $key) selected @endif>
                                    {{ $value }}</option>
                            @endforeach
                        </select>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="form-group__input">
                        <span class="nftmax-wc__icon"><svg class="inline" xmlns="http://www.w3.org/2000/svg" width="22"
                        ...
                        <input class="nftmax-wc__form-input" type="email" name="email" placeholder="Enter your email"
                            value="{{ old('email') }}">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="form-group__input">
                        <span class="nftmax-wc__icon"><svg class="inline" width="18" height="21" viewBox="0 0 18 21"
