                                    ...
                                    <div class="dashboard-banner__main">
                                        <div class="dashboard-banner__column dashboard-banner__column--one">
                                            ...
                                            <div class="nftmax-header__author nftmax-header__author-two ">
                                                <div class="nftmax-header__author-img"><img src=""
                                                        alt="#"></div>
                                                <div class="nftmax-header__author-content ">
                                                    ...
                                                    <p
                                                        ...
                                                        <a href="#"
                                                            class="nftmax-font-regular nftmax-lspacing">User name</a>
                                                    </p>
                                                </div>
                                            </div>
                                    ...
                                    <div class="trending-action__slider">
                                        ...
                                        <div class="trending-action__single">
                                            ...
                                            <div class="trending-action__body">
                                                ...
                                                <h2 class="trending-action__title"><a href="active-bids.html">
                                                        $TrendingAction['3'] </a></h2>
                                        ...
                                        <div class="seller-list__single-slider">
                                            <div class="seller-list__single">
                                                ...
                                                <div class="seller-list__body">
                                                    <h4 class="sell-list__title"><a href="#">
                                                            $TopSeller['2'] </a></h4>
                                                    <p class="sell-list__author"><a href="#">
                                                            $TopSeller['3'] </a></p>
                                                    <div class="sell-list__item nftmax-scolor"><img
                                                            src="  $TopSeller['4']   " alt="#">
                                                        $TopSeller['5'] Items</div>
                                                </div>
                                            </div>
                                        </div>
                                        {{-- @endforeach --}}
                                    ...
                                    <div class="seller-list__slider">
                                        ...
                                        <div class="seller-list__single-slider">
                                            <div class="seller-list__single">
                                                <!-- Seller Head -->
                                                <div class="seller-list__head">
                                                    <div class="verfify-sign"><img src="  asset($TopBuyer['0'])   "
                                                            alt="#">
                                                    </div>
                                                ...
                                                <!-- Seller Body -->
                                                <div class="seller-list__body">
                                                    <h4 class="sell-list__title"><a href="#"> $TopBuyer['2']
                                                        </a></h4>
                                                    <p class="sell-list__author"><a href="#"> $TopBuyer['3']
                                                        </a></p>
                                                    <div class="sell-list__item sell-list__v2 nftmax-pcolor"><img
                                                            src="  asset($TopBuyer['4'])   " alt="#">$
                                                        $TopBuyer['5'] M</div>
                                                </div>
                                            </div>
                                        </div>
