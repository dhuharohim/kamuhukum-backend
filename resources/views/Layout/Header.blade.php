                    ...
                    <div class="admin-menu__two mg-top-50">
                        ...
                        <div class="menu-bar">
                            <ul class="menu-bar__one">
                                ...
                                <li class="{{ request()->routeIs(['cms.*']) ? 'active' : '' }}">
                                    <a href="{{ route('cms.index') }}"><span class="menu-bar__text">
                                            <span class="nftmax-menu-icon nftmax-svg-icon__v9">
                                                <svg class="nftmax-svg-icon" viewBox="0 0 24 24"
                                            ...
                                            <span class="menu-bar__name">CMS</span></span>
                                    </a>
                                </li>
                            </ul>
                        </div>
